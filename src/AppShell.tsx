...
export default function AppShell() {
  ...
  async function refreshLocalState() {
    const [nextHistory, nextCredits, nextConsent] = await Promise.all([
      getScanHistory(),
      getCredits(),
      hasGivenConsent(),
    ]);
  ...
  async function handlePayment() {
    ...
    try {
      ...
      setErrorText(
        "Payment was successful, but resume generation failed. Please try again.",
      );
    } finally {
      setIsPaying(false);
    }
      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        {screen === "home" ? (
          <View style={styles.section}>
            <Text style={styles.heroTitle}>
              Paste resume. See rejection risk. Pay only if it feels worth it.
            </Text>
            <Text style={styles.heroSubtitle}>
              Built for India job seekers who need a stronger resume fast, not
            ...
            <TextInput
              ...
              onChangeText={(text) => {
                setResumeText(text);
                if (text.trim()) setSelectedResume(null);
              }}
            ...
            >
              ...
              <Text style={styles.consentText}>
                I agree my resume will be processed by OpenAI's API for ATS
                analysis. No account needed. Resume data is not stored on our
                servers.
              </Text>
            </TouchableOpacity>
        ...
        {screen === "processing" ? (
          <View style={styles.section}>
            ...
            <Text style={styles.sectionTitle}>
              We&apos;re optimizing your resume now
            </Text>
            <Text style={styles.sectionBody}>
              Checking ATS score, rejection risk, missing keywords, and stronger
              bullet points.
            </Text>
            <ProgressSteps steps={processingSteps} />
            <Text style={styles.retryNote}>
              We&apos;re optimizing your resume, retrying automatically if the
              AI call fails.
            </Text>
          </View>
        ) : null}
        ...
        {screen === "analysis" && analysis ? (
          <View style={styles.section}>
            ...
            <Text style={styles.sectionTitle}>
              {getAnalysisHeadline(analysis.atsScore)}
            </Text>
            ...
            />
            <Text style={styles.fearPrime}>
              {getFearPrime(analysis.atsScore)}
            </Text>
            ...
            <View style={styles.previewCard}>
              ...
              <View style={styles.previewBefore}>
                ...
                <Text style={styles.previewText}>
                  {analysis.preview?.before ?? beforeSample}
                </Text>
              </View>
              ...
              <View style={styles.previewAfter}>
                ...
                <Text style={styles.previewText}>
                  {analysis.preview?.after ?? afterSample}
                </Text>
              </View>
              ...
              <View style={styles.blurContainer}>
                ...
                <Text style={styles.blurText}>
                  Keywords injected: React, Node.js, Git...
                </Text>
              </View>

              <Text style={styles.unlockCTA}>
                Unlock your full improved resume
              </Text>
            </View>
            <Text style={styles.retryNote}>
              We are optimizing your resume. If the AI call fails, the app
        ...
        {screen === "result" && analysis && currentRecord ? (
          <View style={styles.section}>
            ...
            <ViewShot
              options={{
                fileName: "resume-fixer-scorecard",
                format: "png",
                quality: 1,
              }}
              ref={scorecardRef}
            ...
            <ExportPackageCard
              ...
              sections={[
                {
                  title: "Experience",
                  points: analysis.improvedResume.experience
...
const styles = StyleSheet.create({
  ...
  consentRow: { alignItems: "flex-start", flexDirection: "row", gap: 12 },
  checkbox: {
    alignItems: "center",
    backgroundColor: palette.panelSoft,
    borderColor: palette.stroke,
  ...
  checkboxChecked: { backgroundColor: palette.mint, borderColor: palette.mint },
  checkmark: { color: palette.bg, fontSize: 13, fontWeight: "800" },
  consentText: {
    color: palette.textMuted,
    flex: 1,
    fontSize: 13,
